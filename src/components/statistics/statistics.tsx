...
export function Statistics() {
  ...
  const ordersDone = orders.filter((order: IOrder) => order.status === 'done').splice(0, 30);
  const ordersPending = orders.filter((order: IOrder) => order.status === 'pending').splice(0, 30);
